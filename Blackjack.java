...
public class Blackjack {
        ...
        do {
            ...
            if (userScore <= 21) {
                ...
                if (dealerScore > 21) {
                    ...
                    System.out.println("Dealer wins! With score: " + dealerScore + " and user score: " + userScore);
                } else {
    ...
    public static String hitOrStay() {
        ...
        while (!playerResult.equals("hit") && !playerResult.equals("stay")) {
            System.out.println("Please write hit or stay");
            playerResult = scan.nextLine();
        }
        return playerResult;
    }
}
